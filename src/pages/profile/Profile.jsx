      ...
      <div className="mt-[50px]">
        <div className="flex flex-col items-center">
          <div className="flex mb-4 gap-[100px] max600:gap-[50px] max7:gap-[20px]">
            <button
              className={`flex items-center text-[18px] px-4 py-2 ${activeTab === "posts"
            ...
            <button
              className={`flex items-center gap-[5px] text-[18px] px-4 py-2 ${activeTab === "saved"
            ...
            <button
              className={`flex items-center text-[18px] gap-[5px] px-4 py-2 ${activeTab === "tagged"
                ? "text-black dark:text-white font-medium border-t-2 border-gray-300"
                : ""
                }`}
