  ...
  const getComment = async () => {
    try {
      const { data } = await axiosRequest.get(
        "Post/get-post-comments?PageSize=300"
      );
      ...
      <div className="text-[#fff] w-[33%] mx-auto pt-[35px] ">
        {reel.map((e) => {
          ...
          return (
            <div
              key={e.postId}
              className="w-full h-[87vh]  rounded-[20px] flex items-end gap-[0px] mb-[40px] bg-[]"
            >
              <div
                className="w-[85%] md:rounded-[6px] overflow-hidden bg-black h-[100%] flex items-center"
                style={{ boxShadow: "0 0 40px 0 #535252" }}
              >
          ...
          <div className="bg-[#201f1f] fixed top-[80px] right-[80px] w-[22%] rounded-[7px]">
              ...
              {reelobj?.map((comment) => {
                ...
                return (
                  <div className="flex gap-[20px] mb-[19px]">
                    {
                      <img
                        className="rounded-[50%] w-[40px] h-[40px] bg-[#000] text-center text-[13px]"
                        src={`${import.meta.env.VITE_APP_FILES_URL}${
            ...
            <div className="w-[86%] mx-auto py-[15px]">
              <input
                ...
                type="text"
                className="w-full h-[35px] pl-[20px] rounded-[20px] bg-[#000] border-[1px] border-[#fff]"
              />
              {addComm.trim().length == 0 ? (
                <button
                  style={{
                    display: addComm.trim().length > 0 ? "block" : "none",
                  }}
                  disabled={true}
                  onClick={() => addComment(idRender)}
                  className="absolute bottom-[25px] right-[32px] text-[13px] font-bold ml-[8px] text-[grey]"
                >
                  Опубликовать
                </button>
              ) : (
                <button
                  ...
                  onClick={() => addComment(idRender)}
                  className="absolute bottom-[25px] right-[32px] text-[13px] font-bold ml-[8px] text-[#0095f6]"
                >
                  Опубликовать
                </button>
              )}
        ...
        {sendModal ? (
          <div className="bg-[#201f1f] fixed top-[80px] right-[80px] w-[22%] rounded-[7px]">
            ...
            <div className="h-[230px] overflow-auto">
              {users.map((e) => {
                console.log(
                  `${import.meta.env.VITE_APP_FILES_URL}${users.avatar}`
                );
            ...
            <div className="w-[86%] mx-auto py-[15px]">
              ...
              <button className="w-full h-[35px] rounded-[7px] bg-[#3b88b8] text-[#fff]">
                Отправить
              </button>
            </div>
          </div>
        ...
        {settingsModal ? (
          <div className="bg-[#201f1f] fixed top-[220px] right-[140px] w-[19%] rounded-[7px] p-[.4%]">
            <div className="transition-all duration-[.3s] hover:bg-[#313030] rounded-[10px] cursor-pointer mx-auto h-[46px] pl-[20px] font-[600] flex items-center justify-between text-[#ae3b3b]">
              Пожаловаться{" "}
              <span
                onClick={() => setSettingsModal(false)}
                className="text-[#888] pr-[20px]"
              >
                X
              </span>
            </div>
            <div className="transition-all duration-[.3s] hover:bg-[#313030] rounded-[10px] cursor-pointer mx-auto h-[46px] pl-[20px] font-[600] flex items-center text-[#5a74da]">
              Подписаться
            </div>
            <div className="transition-all duration-[.3s] hover:bg-[#313030] rounded-[10px] cursor-pointer mx-auto h-[46px] pl-[20px] font-[600] flex items-center">
