              ...
              return (
                ...
                >
                  {e.userAvatar == null || e.userAvatar == "" ? (
                    ...
                    <div className="bg-gradient-to-r  from-purple-500 rounded-[50%] p-[3%] via-pink-500 to-yellow-500 w-[52px] h-[52px]">
                      <div className="bg-white w-[100%] h-[100%] rounded-[50%]">
                        <img
                          onClick={() => {
                            setStoryModal(true);
                          ...
                          className="w-[150px], h-[180px] dark:bg-black p-[4%]  rounded-[100%]"
                          alt=""
                        />
                      </div>
                    </div>
                        ...
                        >
                          {el.avatar == null || el.avatar == "" ? (
                            <img
                              src={userAvatar}
                              alt=""
                              className="w-[20%] object-contain dark:bg-black h-[150px], rounded-[50%] md:w-[15%] lg:w-[13%] xl:w-[15%]"
                            />
                          ) : (
                            <img
                              src={`${import.meta.env.VITE_APP_FILES_URL}${
